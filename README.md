...
```javascript
import mul from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-mul@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/complex-float32-base-mul/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/complex-float32-base-mul/actions/workflows/test.yml?query=branch:v0.2.0
